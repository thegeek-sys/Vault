...
- Poi abbiamo il programma dell’utente (anche chiamato `.text`)
- In seguito i dati statici (`.data`) allocati in assegnamento
bene non sto capendo un cazzo, rivedere (slide 6)
...
- Decodifica/riconoscimento dell’istruzione → la control unit legge i 6 bit dell’op code e inizia a settare
