...
numero righe x numero colonne (credo)
...
## Memory organization
### NUMA systems
![[Pasted image 20251209181637.png]]

le memoria sono fisicamente divise, quindi alcuni core si trovano più vicini ad alcuni core rispetto ad altri

In NUMA systems (non-uniform memory access) he cost of accessing the memory changes depending on where the data is allocated. Accessing a “local” memory is cheaper than accessing a “remote” memory. But it’s possible to:
