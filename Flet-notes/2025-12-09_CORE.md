...
In NUMA systems (non-uniform memory access) he cost of accessing the memory changes depending on where the data is allocated. Accessing a “local” memory is cheaper than accessing a “remote” memory