...
- [[#System call|System call]]
	...
	- [[#System call#Gestione errori system call|Gestione errori system call]]
		- [[#Gestione errori system call#$ verb errno $|errno]]
		- [[#Gestione errori system call#$ verb perror() $|perror]]
		- [[#Gestione errori system call#$ verb strerror() $|strerror()]]
...
- [[#Allocazione di memoria|Allocazione di memoria]]
	- [[#Allocazione di memoria#$ verb brk $, $ verb sbrk $ system call|brk, sbrk system call]]
	- [[#Allocazione di memoria#$ verb realloc $|realloc]]
- [[#Memory leakage|Memory leakage]]
	- [[#Memory leakage#$ verb memset() $ e $ verb memcpy() $|memset e memcpy]]
	- [[#Memory leakage#$ verb mmap $|mmap]]
