...
- [[#$ verb MPI_Scatter$|MPI_Scatter]]
	- [[#$ verb MPI_Scatter $#In place|In place]]
- [[#$ verb MPI_Gather$|MPI_Gather]]
...
- [[#MPI derived datatypes|MPI derived datatypes]]
	...
	- [[#MPI derived datatypes#$ verb MPI_Type_commit$|MPI_Type_commit]]
	- [[#MPI derived datatypes#$ verb MPI_Type_free$|MPI_Type_free]]
