...
- [[#Comunicazioni|Comunicazioni]]
	...
	- [[#Comunicazioni#Comunicazione a livello trasporto|Comunicazione a livello trasporto]]
	- [[#Comunicazioni#Comunicazione a livello rete|Comunicazione a livello rete]]
	- [[#Comunicazioni#Comunicazione a livello di collegamento|Comunicazione a livello di collegamento]]
- [[#Link|Link]]
- [[#Servizi offerti dal livello di collegamento|Servizi offerti dal livello di collegamento]]
	- [[#Servizi offerti dal livello di collegamento#Framing|Framing]]
	- [[#Servizi offerti dal livello di collegamento#Consegna affidabile|Consegna affidabile]]
	- [[#Servizi offerti dal livello di collegamento#Controllo di flusso|Controllo di flusso]]
	- [[#Servizi offerti dal livello di collegamento#Rilevazione degli errori|Rilevazione degli errori]]
	- [[#Servizi offerti dal livello di collegamento#Correzione degli errori|Correzione degli errori]]
- [[#Adattatori|Adattatori]]
- [[#Due sottolivelli|Due sottolivelli]]
- [[#Errori su bit|Errori su bit]]
	- [[#Errori su bit#Tecniche di rilevazione degli errori|Tecniche di rilevazione degli errori]]
		- [[#Tecniche di rilevazione degli errori#Controllo di parità|Controllo di parità]]
---
## Comunicazioni
...
Due utenti che comunicano possono immaginare che tra di essi esista un canale logico bidirezionale attraverso il quale si possono inviare messaggi nonostante la comunicazione reale avviene attraverso più livelli e più dispositivi, e vari canali fisici
