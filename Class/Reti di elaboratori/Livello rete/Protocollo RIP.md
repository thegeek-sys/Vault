...
- **poisoned reverse** → se un nodo usa un vicino per raggiungere una destinazione (guasta o non), segnala attivamente a quel vicino che il percorso ha costo $\infty$, così il vicino non sarà tentato di usarlo per quella destinazione.
