...
- [[#Segmenti TCP|Segmenti TCP]]
	- [[#Segmenti TCP#Struttura dei segmenti|Struttura dei segmenti]]
		- [[#Struttura dei segmenti#Flag di controllo|Flag di controllo]]
- [[#Connessione TCP|Connessione TCP]]
	- [[#Connessione TCP#Apertura della connessione - 3 way handshake|Apertura della connessione - 3 way handshake]]
	- [[#Connessione TCP#Trasferimento dati|Trasferimento dati]]
		- [[#Trasferimento dati#Push|Push]]
		- [[#Trasferimento dati#Urgent|Urgent]]
	- [[#Connessione TCP#Chiusura della connessione|Chiusura della connessione]]
		- [[#Chiusura della connessione#Half close|Half close]]
- [[#Gestione degli errori|Gestione degli errori]]
	- [[#Gestione degli errori#Numeri di sequenza e ACK|Numeri di sequenza e ACK]]
	- [[#Gestione degli errori#Affidabilità TCP (controllo degli errori)|Affidabilità TCP (controllo degli errori)]]
	- [[#Gestione degli errori#Generazione di ACK|Generazione di ACK]]
		- [[#Generazione di ACK#Ritrasmissione dei segmenti|Ritrasmissione dei segmenti]]
	- [[#Gestione degli errori#FSM mittente|FSM mittente]]
	- [[#Gestione degli errori#FSM destinatario|FSM destinatario]]
	- [[#Gestione degli errori#Normale operatività|Normale operatività]]
	- [[#Gestione degli errori#Segmento smarrito|Segmento smarrito]]
	- [[#Gestione degli errori#Ritrasmissione rapida|Ritrasmissione rapida]]
	- [[#Gestione degli errori#Riscontro smarrito senza ritrasmissione|Riscontro smarrito senza ritrasmissione]]
	- [[#Gestione degli errori#Riscontro smarrito con ritramissione|Riscontro smarrito con ritramissione]]
	- [[#Gestione degli errori#Riassunto sui meccanismi adottati da TCP|Riassunto sui meccanismi adottati da TCP]]
- [[#Controllo del flusso|Controllo del flusso]]
	- [[#Controllo del flusso#Finestra di invio|Finestra di invio]]
- [[#Controllo della congestione|Controllo della congestione]]
	- [[#Controllo della congestione#Approcci|Approcci]]
	- [[#Controllo della congestione#Problematiche|Problematiche]]
	- [[#Controllo della congestione#1. Finestra di congestione|1. Finestra di congestione]]
	- [[#Controllo della congestione#2. Rilevare la congestione|2. Rilevare la congestione]]
	- [[#Controllo della congestione#3. Controllo della congestione|3. Controllo della congestione]]
		- [[#3. Controllo della congestione#Slow start|Slow start]]
		- [[#3. Controllo della congestione#Congestion avoidance|Congestion avoidance]]
	- [[#Controllo della congestione#TCP Tahoe|TCP Tahoe]]
		- [[#TCP Tahoe#FSM|FSM]]
		- [[#TCP Tahoe#Affinamento|Affinamento]]
	- [[#Controllo della congestione#TCP Reno|TCP Reno]]
		- [[#TCP Reno#FSM|FSM]]
	- [[#Controllo della congestione#Timeout|Timeout]]
		- [[#Timeout#Impostazione del timeout|Impostazione del timeout]]
---
## Introduction
